    ...
    <motion.div className="mb-16"
      ...
      <div className="mb-6 rounded-lg border border-sky-200 dark:border-sky-800/50 bg-sky-50 dark:bg-sky-950/30 p-4">
        ...
        <p className="mt-2 text-xs text-sky-800 dark:text-sky-300">
          The S6 numbers below are retained as the reproducible baseline-comparison snapshot. Phase 2 (#48) first iteration (<span className="font-mono">hf_v02_tiny_aug_ext</span>, 2026-05-03 RunPod GPU run) achieved <span className="font-mono">overall F1 45.2 %</span> / <span className="font-mono">P 30.3 %</span> / <span className="font-mono">R 88.3 %</span> on v0.12.0 adversarial — below the matched-precision floor and below the spaCy <span className="font-mono">pleno_ner</span> baseline. The custom CNN baseline therefore retains the operational lead; do not read these rows as the current production-quality estimate.
        </p>
      </div>
